(function () {
  ...
  function setLanguage(lang) {
    ...
    const titleElement = document.getElementById("page-title") || document.querySelector("title");
    ...
    document.querySelectorAll("[data-placeholder-en][data-placeholder-es]").forEach((element) => {
      const placeholder = safeLang === "es" ? element.getAttribute("data-placeholder-es") : element.getAttribute("data-placeholder-en");
      if (placeholder) {
        element.setAttribute("placeholder", placeholder);
      }
    });

    document.querySelectorAll("option[data-label-en][data-label-es]").forEach((option) => {
      option.textContent = safeLang === "es" ? option.getAttribute("data-label-es") : option.getAttribute("data-label-en");
    });
